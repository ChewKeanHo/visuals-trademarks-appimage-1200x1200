# AppImage Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The AppImage Trademarks Logo. The project did not publish any trademark
guidelines and the provided graphical materials are too rasterized for actual
use. The preferred version is `.svg` which has non-destructive scale up & down
properties and can be converted into any rasterized images (e.g. `jpeg`, `webp`,
`avif`, etc). Hence, a re-draw is required.

This project re-draws AppImage Trademarks Logo specifically for 1200x1200 size.
...
Since AppImage does not supply any trademark engineering specification, it is
**assumed standard Trademarks laws applied to avoid any unwanted legal
implications**.

While not specified by AppImage, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: AppImage Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-appiamge-1200x1200
UUID: 39ABF261-C2AE-4819-B9C6-22C18A52C050
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-01-14
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-appimage-1200x1200
--------------------------------------------------------------------------------
```
...
> **YOU ARE STILL OBLIGATED TO COMPLY WITH APPIMAGE TRADEMARK REQUIREMENTS**.
>
